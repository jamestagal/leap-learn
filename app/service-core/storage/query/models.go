...
type OrganisationActivityLog struct {
	ID         uuid.UUID             `json:"id"`
	CreatedAt  time.Time             `json:"created_at"`
...
type OrganisationDocumentBranding struct {
	ID                uuid.UUID      `json:"id"`
	CreatedAt         time.Time      `json:"created_at"`
	UpdatedAt         time.Time      `json:"updated_at"`
	OrganisationID          uuid.UUID      `json:"organisation_id"`
...
type OrganisationFormOption struct {
	ID        uuid.UUID       `json:"id"`
	CreatedAt time.Time       `json:"created_at"`
	UpdatedAt time.Time       `json:"updated_at"`
	OrganisationID  uuid.UUID       `json:"organisation_id"`
...
type OrganisationProposalTemplate struct {
	ID            uuid.UUID       `json:"id"`
	CreatedAt     time.Time       `json:"created_at"`
	UpdatedAt     time.Time       `json:"updated_at"`
	OrganisationID      uuid.UUID       `json:"organisation_id"`
...
type BetaInvite struct {
	...
	UsedByOrganisationID uuid.NullUUID  `json:"used_by_organisation_id"`
...
type Contract struct {
	...
	OrganisationSignatoryName      sql.NullString  `json:"organisation_signatory_name"`
	OrganisationSignatoryTitle     sql.NullString  `json:"organisation_signatory_title"`
	OrganisationSignedAt           sql.NullTime    `json:"organisation_signed_at"`
